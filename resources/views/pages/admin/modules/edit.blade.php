<x-app-layout>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-4">
                            ...
                            <img src="{{ asset('storage/' . $module->image) }}" 
                                 alt="Current Image" 
                                 class="h-40 object-cover rounded-xl border">
                        </div>
                        @endif
                    </div>
    ...
    <script>
        ...
        function addSection(title = '', content = '', existingImage = '', sectionId = null) {
            sectionCount++;
            ...
            if (existingImage) {
                imagePreview = `
                    <div class="mt-2">
                        <img src="${existingImage}" class="h-24 object-cover rounded-xl border">
                    </div>`;
            }
                    ...
                    <div class="space-y-6">                        
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="file" name="images[${sectionCount-1}]" accept="image/*" class="w-full">
                                ${imagePreview}                                
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Video</label>
                                <input type="file" name="videos[${sectionCount-1}]" accept="video/mp4,video/webm" class="w-full">
                            </div>
                        </div>
                    </div>
                </div>
