<x-guest-layout>
    <div class="min-h-screen flex bg-gray-50">
        ...
        <!-- LEFT SIDE - Welcome Back (Desktop Only) -->
        <div class="hidden md:flex w-1/2 bg-gradient-to-br from-purple-700 to-indigo-600 text-white flex-col justify-center items-center p-12 relative overflow-hidden">
            ...
            <div class="max-w-md text-center mt-10">
                ...
                <p class="text-purple-100 text-lg">
                    Masuk ke akun Anda dan lanjutkan perjalanan parenting yang bermakna bersama EasyStep.
                </p>                
            </div>
        </div>
